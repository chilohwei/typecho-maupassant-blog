<div id="secondary">
    ...
    <section class="widget">
        <h3 class="widget-title">公众号</h3>
            <div class="textwidget">
                <a href="#"><img src="https://chilohdata.oss-cn-hongkong.aliyuncs.com/imgs/qrcode.jpg"></a>
                微信号：chilohwei
             </div>
    </section>   
    end wechat -->   
    ...
    <section class="widget">
		<h3 class="widget-title"><?php _e('最新'); ?></h3>
        <ul class="widget-list">
            <?php $this->widget('Widget_Contents_Post_Recent','pageSize=9')
