...
<head>
    ...
    <link rel="shortcut icon" href="https://chilohdata.oss-cn-hongkong.aliyuncs.com/imgs/favicon.ico" type="image/x-icon" />
        ...
        <div class="col-group">
            ...
            <div>
                <nav id="nav-menu" class="clearfix">
                    <a class="<?php if($this->is('index')): ?>current<?php endif; ?> <?php if($this->is('post')): ?>current<?php endif; ?>" href="<?php $this->options->siteUrl(); ?>"><?php _e('首页'); ?></a>
